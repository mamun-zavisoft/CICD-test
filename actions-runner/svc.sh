...
SVC_NAME="actions.runner.mamun-zavisoft-CICD-test.ip-172-31-26-23.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (mamun-zavisoft-CICD-test.ip-172-31-26-23)"
